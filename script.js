...
var footprint = inputs.sqft / inputs.storyMultiplierRaw;
...
function storyMultiplierFor(storyCount) {
if (storyCount === 1) { return 1.0; }
if (storyCount === 2) { return 1.15; }
return 1.3;
}
...
var storyCount = parseFloat(document.getElementById('stories').value) || 1;
...
sqft: sqft,
storyMultiplierRaw: storyCount,
storyMultiplier: storyMultiplierFor(storyCount),
tierRate: tierRate,
